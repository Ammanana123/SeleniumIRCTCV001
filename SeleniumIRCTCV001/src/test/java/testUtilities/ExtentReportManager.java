	...
	import com.aventstack.extentreports.reporter.configuration.Theme;
	  ...
	  public class ExtentReportManager implements ITestListener {
			...
			{		
				...
				htmlReporter.config().setDocumentTitle("SeleniumIRCTC Automation Report"); // Tile of report
				htmlReporter.config().setReportName("SeleniumIRCTC  Functional Testing"); // name of the report
